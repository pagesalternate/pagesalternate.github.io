...
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    containerId: 'custom-gallery-instagram',
    options: {"api":{"sourceId":"IaMWLjFtEQqJepVP"},"gallery":{"rowsPerFetch":3},"header":{"showFilters":false,"showHeader":false,"showSubtitle":false,"showTitle":false,"showUploaderCta":false},"metrics":{"displayType":"Gallery","integrations":{"adobeAnalytics":{"interactionLevel":"interaction","isEnabled":true,"useStandalone":true,"eVars":"eVar89"},"ga":{"isEnabled":true}},"metricsId":"9j8O25Ya"},"reportMedia":{"reelId":"9j8O25Ya"},"theme":{"overrides":{"columns":{"giant":{"num":2},"large":{"num":2},"medium":{"num":2},"hero":{"num":2},"small":{"num":2},"extraSmall":{"num":2},"default":{"num":2}}}},"uploader":{"reelId":"9j8O25Ya"}}
});
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
...
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    ...
    options: {"api":{"sourceId":"epCnPMEPGZvUKAAp"},"header":{"showHeader":true,"showSocialLinks":false,"showSubtitle":false,"showTitle":false,"showUploaderCta":true},"metrics":{"displayType":"Other","integrations":{"adobeAnalytics":{"interactionLevel":"interaction","isEnabled":true,"useStandalone":true,"eVars":"eVar89"},"ga":{"isEnabled":true}},"metricsId":"kgmnGAni"},"reportMedia":{"reelId":"kgmnGAni"},"uploader":{"reelId":"kgmnGAni"}}
});
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    containerId: 'custom-gallery-inspo',
    options: {"api":{"sourceId":"NFxFfUwdahkmPReD"},"metrics":{"displayType":"Gallery","integrations":{"adobeAnalytics":{"interactionLevel":"interaction","isEnabled":true,"useStandalone":true,"eVars":"eVar89"},"ga":{"isEnabled":true}},"metricsId":"1Dhs9j2U"},"reportMedia":{"reelId":"1Dhs9j2U"},"uploader":{"reelId":"1Dhs9j2U"}}
});
window.crl8.EventBus.dispatchEvent('registerExperienceOptions', {
    containerId: 'custom-gallery-spotlight',
    options: {"api":{"sourceId":"CZTZtmuGxbdDGbaX"},"carousel":{"main":{"thumbnail":{"isSquareThumbnail":false}}},"footer":{"showFooter":false,"showGalleryLink":false},"header":{"showHeader":false,"showSocialLinks":false,"showSubtitle":false,"showTitle":false,"showUploaderCta":false},"metrics":{"displayType":"Gallery","integrations":{"adobeAnalytics":{"interactionLevel":"interaction","isEnabled":true,"useStandalone":true,"eVars":"eVar89"},"ga":{"isEnabled":true}},"metricsId":"18NaleHP"},"modal":{"hero":{"isSquare":false}},"reportMedia":{"reelId":"18NaleHP"},"theme":{"overrides":{"columns":{"giant":{"gutter":5,"heightToWidthRatio":1.73,"num":3},"large":{"gutter":5,"heightToWidthRatio":1.73,"num":3},"medium":{"gutter":5,"heightToWidthRatio":1.73,"num":3},"hero":{"gutter":5,"heightToWidthRatio":1.73,"num":2},"small":{"gutter":5,"heightToWidthRatio":1.73,"num":2},"extraSmall":{"gutter":5,"heightToWidthRatio":1.73,"num":2},"default":{"gutter":5,"heightToWidthRatio":1.73,"num":2}}}},"uploader":{"reelId":"18NaleHP"}}
});
window.crl8.EventBus.dispatchEvent('registerContainerMapper', function(containerId) {
    ...
    switch(containerId) {
        ...
        case 'custom-brand':
            experienceName = 'custom-lb-carousel-1593692829557';
            break;
        case 'custom-gallery-inspo':
            experienceName = 'custom-lb-masonry-1597326247619';
            break;
        case 'custom-gallery-spotlight':
            experienceName = 'custom-lb-carousel-1593692829557';
            break;
    }
    return Promise.resolve(experienceName);
});
window.crl8.EventBus.dispatchEvent('initializeCuralatePixel', { pixelId: 106539, useDebug: false });
